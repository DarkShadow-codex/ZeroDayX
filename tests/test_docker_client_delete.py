"""ZeroDayDockerSandboxClient.delete() best-effort teardown.
...
def _client_with_kill_error(exc: Exception) -> ZeroDayDockerSandboxClient:
    """A ZeroDayDockerSandboxClient whose containers.get(...).kill() raises ``exc``."""
    client = ZeroDayDockerSandboxClient.__new__(ZeroDayDockerSandboxClient)
