...
import zeroday.skills as skills_mod
from zeroday.agents.prompt import _resolve_skills, render_system_prompt
from zeroday.skills import (
    get_all_skill_names,
...
def test_no_registration_leaves_builtin_only() -> None:
    ...
    builtin = get_zeroday_resource_path("skills")
