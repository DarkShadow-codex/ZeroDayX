...
from zeroday.config.models import ZeroDayProvider, _TurnGuardModel, _with_idle_timeout
...
def _reset_settings(monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    for key in ("ZERODAY_LLM", "LLM_DISABLE_STREAMING", "LLM_STREAM_IDLE_TIMEOUT"):
