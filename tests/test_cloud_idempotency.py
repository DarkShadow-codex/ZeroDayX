...
from zeroday.interface.cloud import http, runner
from zeroday.interface.completions import completion_candidates
...
def _token(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv("ZERODAY_API_TOKEN", "idempotency-test-token")
