---
title: "Agent Tools"
description: "How ZeroDay agents interact with targets"
---

ZeroDay agents use specialized tools to test your applications like a real penetration tester would.
