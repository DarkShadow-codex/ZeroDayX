---
title: "Contributing"
description: "Contribute to ZeroDay development"
---
...
Skills are specialized knowledge packages that enhance agent capabilities. They live in `zeroday/skills/`
...
the sidecar as `zeroday/bin/zeroday-tui`, and assigns the current platform tag.
Frozen releases built by `scripts/build.sh` and `zeroday.spec` also require the
sidecar.
...
- ZeroDay version (`zeroday --version`)
- LLM being used
...
<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://discord.gg/zeroday-ai">
    Join the community for help and discussion.
  </Card>
  <Card title="GitHub Issues" icon="github" href="https://github.com/usezeroday/zeroday/issues">
