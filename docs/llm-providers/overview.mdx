---
title: "Overview"
description: "Configure your AI model for ZeroDay"
---

ZeroDay uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
...
```bash
export ZERODAY_LLM="ollama/llama4"
