...
description: "Configure ZeroDay with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install ZeroDay with the vertex extra:

```bash
pipx install "zeroday-agent[vertex]"
```

## Setup

```bash
export ZERODAY_LLM="vertex_ai/gemini-3-pro-preview"
```
