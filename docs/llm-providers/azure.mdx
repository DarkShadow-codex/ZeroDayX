---
title: "Azure OpenAI"
description: "Configure ZeroDay with OpenAI models via Azure"
---

## Setup

```bash
export ZERODAY_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `ZERODAY_LLM` | `azure/<your-deployment-name>` |
...
```bash
export ZERODAY_LLM="azure/gpt-5.4-deployment"
