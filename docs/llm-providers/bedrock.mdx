---
title: "AWS Bedrock"
description: "Configure ZeroDay with models via AWS Bedrock"
---

## Installation

Bedrock requires the AWS SDK dependency. Install ZeroDay with the bedrock extra:

```bash
pipx install "zeroday-agent[bedrock]"
```

## Setup

```bash
export ZERODAY_LLM="bedrock/anthropic.claude-4-5-sonnet-20251022-v1:0"
```
