...
ZeroDay agents come equipped with a comprehensive toolkit:
...
ZeroDay uses a graph of specialized agents for comprehensive security testing:
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/usezeroday/zeroday">
