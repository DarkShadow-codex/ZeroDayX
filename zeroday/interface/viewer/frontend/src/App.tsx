...
const TRUST_BANNER =
  "Your findings stay on your machine. They're rendered here locally in your browser and never uploaded or stored by ZeroDay.";
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="border-b border-[#222]">
          <div className="max-w-[88rem] mx-auto px-3 sm:px-6 py-4 flex items-center gap-1.5">
            <a
              href={ctaUrl("https://app.zeroday.ai", "logo")}
              target="_blank"
            ...
            >
              <img src="./logo.png" alt="ZeroDayX" className="w-10 h-8 object-cover rounded" />
              <div className="text-base text-white font-medium tracking-tight">ZeroDayX</div>
            </a>
...
function OverviewTab({
  ...
  return (
    <div className="space-y-6">
      ...
      {finished && (
        <div className="animate-card-in rounded-xl border border-[#222] bg-[rgba(255,255,255,0.02)] p-5">
          <p className="text-sm font-semibold text-white">ZeroDay Cloud</p>
          <p className="mt-0.5 text-xs text-[#666]">Run your next pentest in ZeroDay Cloud.</p>
          <div className="mt-3 flex flex-wrap gap-2.5">
            <ProInlineCta
              label="Run a pentest in ZeroDay Cloud"
...
function AgentsTab({ run, canSteer }: { run: LoadedRun; canSteer: boolean }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Re-run always routes to ZeroDay Cloud. */}
      <div className="rounded-xl border border-[#222] bg-[rgba(255,255,255,0.02)] p-5">
        <p className="text-sm font-semibold text-white">Run this pentest with more depth</p>
        <p className="mt-0.5 text-xs text-[#666]">Run this pentest again in ZeroDay Cloud.</p>
        <div className="mt-3 flex flex-wrap gap-2.5">
          <ProInlineCta
            label="Re-run in ZeroDay Pro with more depth"
