...
export const SIGNUP_URL = "https://app.zeroday.ai/api/auth/signup";
export const DEMO_URL = "https://zeroday.ai/demo";
export const PRICING_URL = "https://zeroday.ai/pricing";
