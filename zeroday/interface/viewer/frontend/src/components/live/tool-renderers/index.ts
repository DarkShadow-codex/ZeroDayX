 ...
 *
 * The OSS zeroday engine (usezeroday/zeroday) is the source of truth for tool names:
 * see `zeroday/tools/**` for definitions and `zeroday/interface/tui/renderers/` for
...
const CATEGORY_TOOLS: Record<ToolCategory, readonly string[]> = {
  ...
  search: ["web_search"],
  // scan_start_info / subagent_start_info are zeroday-app synthetic events; finish_scan is the engine's
