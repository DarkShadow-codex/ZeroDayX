...
const WIDTH_KEY = "zeroday_viewer_sidebar_width";
const COLLAPSE_KEY = "zeroday_viewer_sidebar_collapsed";
...
export default function Sidebar({
  ...
  return (
    <>
      ...
      >
        {/* Header — account-switcher stand-in (links out to ZeroDay Cloud). */}
          ...
          <div className="relative flex flex-col gap-px px-2">
            ...
            <NavItem
              ...
              onClick={() =>
                openUpgrade(
                  "pr_reviews",
                  "ZeroDay reviews every pull request and flags exploitable changes before they merge."
                )
              }
            />
            <NavItem
