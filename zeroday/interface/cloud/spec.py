"""Declarative command table for `zeroday cloud`.
...
SPEC: dict[str, dict[str, Cmd]] = {
    ...
    "domains": {
        ...
        "test-users provision-inbox": Cmd(
            ...
            (
                "Provision a ZeroDay-managed inbox for email OTP or magic-link MFA. "
        ...
        "subscribe": Cmd(
            ...
            body=(
                P(
                    ...
                    required=True,
                    flag="plan",
                    help="Product to buy: zeroday_cloud, zeroday_startup, or zeroday_top_up.",
                ),
    ...
    "uploads": {
        "request": Cmd(
            "POST",
            "/uploads/request",
            "Request an upload URL. To scan local source, prefer `zeroday cloud scans start "
