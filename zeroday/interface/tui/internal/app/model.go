...
// It is set by main from the ZERODAY_VERSION env var (see go_tui.py), matching
// Python's get_package_version() which reads the installed "zeroday-agent" version
...
const (
	...
	setupPlaceholderShort = "What should ZeroDay test?"
...
// splashTick drives the splash "Starting ZeroDay Agent" shimmer at Python's 0.1s cadence.
