"""Execution loop for addressable SDK-backed ZeroDay agents."""
...
from zeroday.core.hooks import (
    BudgetExceededError,
    BudgetPausedError,
    SubagentBudgetReservedError,
)
from zeroday.core.inputs import child_initial_input
from zeroday.core.sessions import (
...
from zeroday.llm.compaction import is_context_overflow, maybe_compact
...
if TYPE_CHECKING:
    ...
    from zeroday.core.agents import AgentCoordinator, Status
