...
from zeroday.core.agents import coordinator_from_context
...
def _coverage_summary(agent_graph: dict[str, Any]) -> dict[str, Any]:
    ...
    """
    from zeroday.report.coverage import agents_from_graph, skill_coverage_gaps
    from zeroday.tools.coverage.tools import get_coverage_entries, outcome_counts
