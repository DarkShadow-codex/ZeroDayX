...
from zeroday.tools.nullish import clean_optional
from zeroday.tools.proxy import caido_api
...
if TYPE_CHECKING:
    ...
    from zeroday.tools.proxy.caido_api import (
        RequestPart,
        SitemapDepth,
        SortBy,
        SortOrder,
    ...
    from zeroday.tools.proxy.caido_api import (  # noqa: TC001
        RequestPart,
        SitemapDepth,
        SortBy,
        SortOrder,
