...
from zeroday.skills import get_loaded_skill_names
from zeroday.telemetry._common import (
    SEND_TIMEOUT,
    SESSION_ID,
    base_props,
    exception_props,
...
_SCARF_ENDPOINT = "https://zeroday.gateway.scarf.sh"
...
def _send(event: str, properties: dict[str, Any]) -> bool:
    ...
    try:
        ...
        version = str(props.pop("zeroday_version", get_version()) or "unknown")
