...
To help make ZeroDay better for everyone, we collect anonymized data that helps us understand how to better improve our AI security agent for our users, guide the addition of new features, and fix common errors and bugs. This feedback loop is crucial for improving ZeroDay's capabilities and user experience.

We use [PostHog](https://posthog.com), an open-source analytics platform, for data collection and analysis, along with [Scarf](https://scarf.sh). Our telemetry implementation is fully transparent - you can review the source code ([posthog.py](https://github.com/usezeroday/zeroday/blob/main/zeroday/telemetry/posthog.py), [scarf.py](https://github.com/usezeroday/zeroday/blob/main/zeroday/telemetry/scarf.py)) to see exactly what we track.
...
**System Context:** OS type, architecture, ZeroDay version\
...
Telemetry in ZeroDay is entirely **optional**:

```bash
export ZERODAY_TELEMETRY=0
```

You can set this environment variable before running ZeroDay to disable **all** telemetry.
