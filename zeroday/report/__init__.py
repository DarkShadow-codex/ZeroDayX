...
from zeroday.report.state import ReportState, get_global_report_state, set_global_report_state


if TYPE_CHECKING:
    from zeroday.report.dedupe import check_duplicate
...
def __getattr__(name: str) -> Any:
    ...
    if name == "check_duplicate":
        return import_module("zeroday.report.dedupe").check_duplicate
