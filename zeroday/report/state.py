...
from zeroday.report.coverage import write_coverage
from zeroday.report.pricing import resolve_litellm_model
from zeroday.report.sarif import write_sarif
from zeroday.report.writer import (
    read_run_record,
    write_executive_report,
    write_run_record,
    write_vulnerabilities,
)
from zeroday.telemetry import posthog, scarf
...
class ReportState:
    ...
    persistence. This store keeps only ZeroDay-owned scan artifacts and
    ...
    def __init__(self, run_name: str | None = None):
        ...
        from zeroday.report.usage import LLMUsageLedger
...
"""
    ...
    def _coverage_document(self) -> dict[str, Any] | None:
        ...
        """
        try:
            from zeroday.report.coverage import build_coverage_document, read_agent_graph
            from zeroday.tools.coverage.tools import get_coverage_entries
...
class StreamedOpenRouterCosts:
    ...
    scan streams, so the OpenRouter streaming handler (see zeroday.config.models)
